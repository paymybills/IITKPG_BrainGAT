...
Figure~\ref{fig:hyperparameter_heatmap} shows an illustrative slice of the grid search, summarising how validation accuracy varies as a function of learning rate and dropout around the final chosen configuration.

\begin{figure}[H]
  \centering
  \includegraphics[width=0.8\textwidth]{hyperparameter_heatmap.png}
  \caption{Hyperparameter sensitivity heatmap showing validation accuracy across different combinations of learning rate and dropout. Darker regions indicate better performance, with the best region corresponding to the final protocol settings.}
